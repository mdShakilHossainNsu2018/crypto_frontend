...
export function login({commit, state}, data){
    ...
    axios.post('http://backend.ovexbroker.co.za/api/' + 'users/auth/login/', data).then(res => {
        //  save in local
...
export function signup({commit, state}, data){
    ...
    axios.post('http://backend.ovexbroker.co.za/api/' + 'users/auth/registration/', data).then(() => {
...
export function getUserByToken({commit, state}, data){
    ...
    axios.post('http://backend.ovexbroker.co.za/api/' + 'users/userbytoken/', TOKEN).then(res => {
